...
// TestService is the server API for Test service.
type TestService interface {
	UnaryCall(*gpbrpc.RPCHelper, *SimpleRequest) *SimpleResponse
	// This RPC streams from the server only.
	Downstream(*gpbrpc.RPCHelper, *SimpleRequest) *StreamMsg
	// This RPC streams from the client.
	Upstream(*gpbrpc.RPCHelper, *StreamMsg) *SimpleResponse
	// This one streams in both directions.
	Bidi(*gpbrpc.RPCHelper, *StreamMsg) *StreamMsg2
...
func NewTestService(s TestService) gpbrpc.ServerInterface {
	return &Test{&gpbrpc.RPCHelper{}, s}
}

func (s *Test) NewHandle() gpbrpc.ServerInterface {
	return &Test{&gpbrpc.RPCHelper{}, gpbrpc.NewStruct(s.TestService).(TestService)}
}
...
func (s *Test) HandleReq(req *gpbrpc.RPCRequestPacket) (msg []byte, ret int32, err error) {
	if req.FuncName == "UnaryCall" {
		...
		if err = proto.Unmarshal(req.ReqPayload, in); err != nil {
			...
			msg, err = proto.Marshal(s.UnaryCall(s.RPCHelper, in))
		}
		...
		if err = proto.Unmarshal(req.ReqPayload, in); err != nil {
			...
			msg, err = proto.Marshal(s.Downstream(s.RPCHelper, in))
		}
		...
		if err = proto.Unmarshal(req.ReqPayload, in); err != nil {
			...
			msg, err = proto.Marshal(s.Upstream(s.RPCHelper, in))
		}
		...
		if err = proto.Unmarshal(req.ReqPayload, in); err != nil {
			...
			msg, err = proto.Marshal(s.Bidi(s.RPCHelper, in))
		}
	} else {
